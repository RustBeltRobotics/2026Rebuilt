...
/**
 * Class that extends the Phoenix 6 TunerSwerveDrivetrain class and implements
...
public class CommandSwerveDrivetrain extends TunerSwerveDrivetrain implements Subsystem {
    ...
    protected MapleSimSwerveDrivetrain mapleSimSwerveDrivetrain = null;
    ...
    public Command sysIdQuasistatic(SysIdRoutine.Direction direction) {
        return startSysIdLogging().andThen(m_sysIdRoutineToApply.quasistatic(direction));
    }
    ...
    public Command sysIdDynamic(SysIdRoutine.Direction direction) {
        return startSysIdLogging().andThen(m_sysIdRoutineToApply.dynamic(direction));
    }
...
*/
    ...
    private void startSimThread() {
        mapleSimSwerveDrivetrain = new MapleSimSwerveDrivetrain(
                ...
                Pounds.of(Constants.Kinematics.LOADED_MASS), // robot weight
                Inches.of(Constants.Kinematics.LENGTH_WITH_BUMPERS), // bumper length
                Inches.of(Constants.Kinematics.WIDTH_WITH_BUMPERS), // bumper width
                DCMotor.getKrakenX60(1), // drive motor type
                DCMotor.getKrakenX44(1), // steer motor type
                Constants.Kinematics.WHEEL_COEFFECIENT_OF_FRICTION, // wheel COF
                getModuleLocations(),
                getPigeon2(),
                getModules(),
